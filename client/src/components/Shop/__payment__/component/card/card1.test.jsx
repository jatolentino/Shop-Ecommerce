      ...
      <div className="card-item__side -front">
        ...
        <div className="card-item__cover">
          <img
            alt=""
            src={
              require(`../../../../../assets/img/card-background/${BACKGROUND_IMG}`)
                .default
            }
        ...
        <div className="card-item__wrapper">
          <div className="card-item__top">
            <img src={ require("../../../../../assets/img/chip.png").default } alt="" className="card-item__chip" />
            <div className="card-item__type">
              <img
                alt={useCardType}
                src={
                  require(`../../../../../assets/img/card-type/${useCardType}.png`)
                    .default
                }
          ...
          <div className="card-item__content">
            ...
            >
              ...
              <TransitionGroup component="div" className="slide-fade-up">
                  {
                    cardHolder === "FULL NAME" && (theName !== " "  ? 
                    (
                        theName && (theName.split("").map((val, index) => (
                            <CSSTransition
                              timeout={250}
...
||
                    ...
                    cardHolder !== "FULL NAME" && (theName === "" && cardHolder === "FULL NAME" ? 
                    (
                        <CSSTransition classNames="slide-fade-up" timeout={250}>
                            <div>FULL NAME</div>
                        </CSSTransition>
